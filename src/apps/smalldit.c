 ...
 * 07/04/2002: Tidied up trans_ev a bit and added printing support (orudge)
...
static p_menu  smalldit_menu_init ( void )
{
  p_menu menu = new_menu(
                  ...
                  new_sub_menu(TXT_FILE, new_menu(
                     ...
                     new_menu_line(
                     new_menu_item(TXT_PRINT, "", 0, MSG_PRINT, NULL,
                     new_menu_line(
   ...
   if (event->type == EV_MESSAGE)
   {
      switch (event->message)
      {
         ...
         case MSG_PRINT: /* print */
            ...
            print_text_from_buffer(editor->text);
            break;
...
//               current_path = get_key("current/seal/smalldit/last_save_dir");
            ...
            break;
         case MSG_ABOUT:
            seal2_app_about("Text Editor", load_image("bmp/icons/smalldit.ico,32"));
...
void  init_smalldit ( void )
{
   ...
   edit->icon16 = load_image("bmp/icons/smalldit.ico,16");
...
SetInfoCopyright("(c) Copyright 1999 Michal Stencl, 2001-2002 Seal System. All rights reserved");
