...
/* Revision History:
  ...
  02/06/2002 - Update for 2.00.12 (orudge)
*/
...
SetInfoCopyright("Copyright (c) SEAL Developers 2001-2003. All Rights Reserved.");
...
#define SCROLL_ITEMS   86 // including UNDERLINEs, etc
...
"=v", // version
"",
"Copyright \xA9 SEAL Developers 2001-2003",  /// A9 = 169 = copyright symbol
"",
"All Rights Reserved.",
"",
"Maintainer",
"",
"David Fredin <davidhimself@users.sourceforge.net>",
UNDERLINE,
"Current Seal-maintainer started The Desktop",
"",
"Programming",
"",
...
"isn't, e-mail davidhimself@users.sourceforge.net.",
"",
"",
