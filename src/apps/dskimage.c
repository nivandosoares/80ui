...
/* SEAL Disk Image Utility
   Copyright (c) Alexandr Levitsky 2001. All Rights Reserved.
*/
...
void trans_ev ( p_object o, p_event event )
{
  ...
  if ( o->process & PH_PREPROCESS ) {
		...
		// IMAGE TO DISK
            ...
            {
               clear_event(event);
               seal2_app_about("Disk Imager", load_image("/system/bmp/icons/35floppy.ico"));
...
void init_hello ( void )
{
   ...
   hello->icon16 = load_image("bmp/icons/35floppy.ico,16");
