...
lib_begin ( void ) {
  ...
  if ( ap_process == AP_INIT ) {
    ...
    //load_cp();
    cps_display = add_cp_section(TXT_DISPLAY,TXT_DISPLAYSETTINGS,TXT_DISPLAYINFO,NULL,load_image("bmp/icons/cp_disp.ico"));
    cps_hardware = add_cp_section(TXT_HARDWARE,TXT_HARDWARESETTINGS,TXT_HARDWAREINFO,NULL,load_image("bmp/icons/cp_hard.ico"));
