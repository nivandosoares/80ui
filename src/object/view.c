 ...
 *
 * 12/05/2002: Added support for AbSEAL skinning (orudge)
 *
 * 16/01/2003: Added minimalistic comments of 4 functions (xduffy)
 */
...
/*
  This function assigns a rect and just puts the width and the height to it and returns..
*/
...
/*
  You get the global positioning of t_rect r on the desktop.
*/
...
/*
  You get the local positioning of the t_rect r in the p_view o.
*/
...
/*
  You get the global position of the t_point p on the desktop.
*/
...
/*
  You get the local position of the t_point p in the p_view o.
*/
...
/*
  This function calls a function that assigns a rect
  and just puts the width and the height to it and returns..
*/
...
p_skin get_local_view_skin(p_view o)
{
   while (o)
   {
      if (o->brush.skin)
      ...
      o = (p_view) OBJECT(o)->owner_view(OBJECT(o));
   }
